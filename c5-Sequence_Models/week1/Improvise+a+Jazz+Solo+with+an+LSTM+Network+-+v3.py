...
def djmodel(Tx, n_a, n_values):
    ...
    model = Model(inputs=[X, a0, c0], outputs=outputs, name='Jazz')
...
def music_inference_model(LSTM_cell, densor, n_values = 78, n_a = 64, Ty = 100):
    ...
    # Model(inputs=[X, a0, c0], outputs=outputs, name='Jazz')
    inference_model = Model(inputs=[x0, a0, c0], outputs=outputs, name='Jazz')
